...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visitor.income'
        db.add_column('HundredNights_visitor', 'income',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visitor.ethnicity'
        db.add_column('HundredNights_visitor', 'ethnicity',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visitor.income'
        db.delete_column('HundredNights_visitor', 'income')

        # Deleting field 'Visitor.ethnicity'
        db.delete_column('HundredNights_visitor', 'ethnicity')
