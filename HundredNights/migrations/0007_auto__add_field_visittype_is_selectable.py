...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VisitType.is_selectable'
        db.add_column('HundredNights_visittype', 'is_selectable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VisitType.is_selectable'
        db.delete_column('HundredNights_visittype', 'is_selectable')
