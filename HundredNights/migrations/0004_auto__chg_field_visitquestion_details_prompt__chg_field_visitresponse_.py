...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VisitQuestion.details_prompt'
        db.alter_column('HundredNights_visitquestion', 'details_prompt', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'VisitResponse.details'
        db.alter_column('HundredNights_visitresponse', 'details', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'VisitQuestion.details_prompt'
        db.alter_column('HundredNights_visitquestion', 'details_prompt', self.gf('django.db.models.fields.CharField')(default='', max_length=150))

        # Changing field 'VisitResponse.details'
        db.alter_column('HundredNights_visitresponse', 'details', self.gf('django.db.models.fields.CharField')(default='', max_length=2000))
