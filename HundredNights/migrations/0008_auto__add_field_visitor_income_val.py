...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visitor.income_val'
        db.add_column('HundredNights_visitor', 'income_val',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visitor.income_val'
        db.delete_column('HundredNights_visitor', 'income_val')
