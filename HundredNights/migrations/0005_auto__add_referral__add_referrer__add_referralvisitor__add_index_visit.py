...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('HundredNights_referral', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('referrer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HundredNights.Referrer'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('HundredNights', ['Referral'])

        # Adding model 'Referrer'
        db.create_table('HundredNights_referrer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal('HundredNights', ['Referrer'])

        # Adding model 'ReferralVisitor'
        db.create_table('HundredNights_referralvisitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('referral', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HundredNights.Referral'])),
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HundredNights.Visitor'])),
            ('visit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HundredNights.Visit'], null=True, blank=True)),
        ))
        db.send_create_signal('HundredNights', ['ReferralVisitor'])

        # Adding index on 'Visitor', fields ['name']
        db.create_index('HundredNights_visitor', ['name'])


    def backwards(self, orm):
        # Removing index on 'Visitor', fields ['name']
        db.delete_index('HundredNights_visitor', ['name'])

        # Deleting model 'Referral'
        db.delete_table('HundredNights_referral')

        # Deleting model 'Referrer'
        db.delete_table('HundredNights_referrer')

        # Deleting model 'ReferralVisitor'
        db.delete_table('HundredNights_referralvisitor')
