...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VisitorQuestion'
        db.create_table('HundredNights_visitorquestion', (
        ...
        db.send_create_signal('HundredNights', ['VisitorQuestion'])

        # Adding model 'VisitorResponse'
        db.create_table('HundredNights_visitorresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HundredNights.Visitor'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['HundredNights.VisitorQuestion'])),
            ('bool_response', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('HundredNights', ['VisitorResponse'])


    def backwards(self, orm):
        # Deleting model 'VisitorQuestion'
        db.delete_table('HundredNights_visitorquestion')

        # Deleting model 'VisitorResponse'
        db.delete_table('HundredNights_visitorresponse')
